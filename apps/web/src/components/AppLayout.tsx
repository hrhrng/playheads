      ...
      <div className="bg-gemini-hover/50 rounded-3xl mx-2 py-4 flex flex-col gap-2 overflow-hidden overflow-y-auto max-h-[calc(100vh-300px)]">
        ...
        <div className="mx-2">
          <button
            ...
            className={`w-full p-3 rounded-xl text-gemini-subtext hover:bg-white transition-colors flex items-center overflow-hidden whitespace-nowrap ${!isMobile && !expanded ? 'justify-center' : ''}`}
          >
