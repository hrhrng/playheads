...
export const AppLayout = ({ children, rightPanel, onNewChat, onSelectConversation, onDeleteConversation, onPinConversation, conversations = [], activeConversationId = null }) => {
    const [expanded, setExpanded] = useState(false);
    const [deleteDialogOpen, setDeleteDialogOpen] = useState(false);
    const [conversationToDelete, setConversationToDelete] = useState(null);

    // Handle pin click
    const handlePin = (conv, e) => {
        e.stopPropagation();
