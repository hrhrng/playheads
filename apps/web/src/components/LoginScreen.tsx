    ...
    <div className="min-h-screen w-full flex flex-col items-center justify-center p-6 relative">
      <div className="flex flex-col items-center space-y-10 max-w-sm w-full animate-fade-in">
        ...
        <div className="text-center space-y-3">
          ...
          <p className="text-[11px] font-mono text-ink-3 uppercase tracking-[0.25em]">{t('auth.tagline')}</p>
        </div>
        ...
        <div className="w-full space-y-4 pt-2">
          ...
          <form onSubmit={onLogin} className="space-y-3">
            ...
            >
              {loading ? t('auth.sendingMagicLink') : t('auth.signInWithEmail')}
            </button>
          </form>
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-[11px] text-ink-3 font-mono uppercase tracking-widest">{t('auth.or')}</span>
            <div className="flex-1 h-px bg-rule" />
          </div>
